pub mod c_interface {
  ...
  pub mod diffusions {
    #[no_mangle]
    pub extern "C" fn ou(n: isize, mu: f64, sigma: f64, theta: f64, x0: f64, t: f64) -> *mut f64 {
    ...
    pub extern "C" fn cir(
      ...
      let cir = crate::diffusions::cir::cir(theta, mu, sigma, n, Some(x0), Some(t), Some(use_sym));
    ...
    pub extern "C" fn jacobi(
      ...
      let jacobi = crate::diffusions::jacobi::jacobi(alpha, beta, sigma, n, Some(x0), Some(t));
